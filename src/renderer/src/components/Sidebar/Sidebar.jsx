...
const Sidebar = memo(
  ({
    ...
    useEffect(() => {
      ...
      if (window.api && window.api.update) {
        ...
        if (window.api.update.onDownloadProgress) {
          cleanups.push(
            window.api.update.onDownloadProgress((percent) => {
    ...
    return (
      <aside className={`main-sidebar ${testStarted && isZenMode ? 'zen-active' : ''}`}>
        ...
        <div className="sidebar-bottom">
          ...
          >
            ...
            <div className="profile-trigger" onClick={onProfileClick}>
              ...
              {currentLevel !== undefined && (
                <div className="sidebar-level-badge">{currentLevel}</div>
              )}
